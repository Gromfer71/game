...
return [
    'wrongAuth' => 'Неверное имя пользователя или пароль!',

    'castle' => 'Замок',
    'castleDescribe' => 'Плац увеличивает максимальное количество войск в походе.',
    // Замок - основная постройка. При повышении уровня замка открываются новые здания и возможности.
    'system' => 'Система',
    ...
    //errors
    'zeroChoose' => 'Ничего не выбрано!',
    'wrongMonster' => 'Неправильно выбран монстр!',
